...
class gene(object):
    ...
    def mutate(self):
        ...
        """
        self.pos_1 = (random.randint(0, self.width), random.randint(0, self.height))
        self.pos_2 = (random.randint(0, self.width), random.randint(0, self.height))
        self.pos_3 = (random.randint(0, self.width), random.randint(0, self.height))
        # self.pos_4 = (random.randint(0, self.width), random.randint(0, self.height))
        # self.pos_5 = (random.randint(0, self.width), random.randint(0, self.height))
